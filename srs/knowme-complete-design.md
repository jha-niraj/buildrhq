...
│  │                                                          │  │
│  │  Share your AI:                                         │  │
│  │  🔗 shipithq.com/knowme/yourusername                     │  │
...
│  │    🔗 [View Project]                                     │  │
│  │                                                          │  │
│  │  I scored 95% on the React assessment on ShipItHQ.        │  │
│  │                                                          │  │
...
│     │   ├─► Detect duplicates with ShipItHQ projects              │
...
│  │  • 3 duplicates detected with your ShipItHQ projects         │  │
│  │    [Review Merges]                                        │  │
│  │                                                          │  │
...
│  │                                                          │  │
│  │  import { KnowMeChat } from '@shipit/knowme-widget';     │  │
│  │                                                          │  │
│  │  function Portfolio() {                                  │  │
│  │    return (                                              │  │
│  │      <div>                                               │  │
...
│  │  → Questions sent to ShipItHQ API                          │  │
...
**Problem**: Same project on ShipItHQ AND GitHub creates confusion
**Solution**:
- Auto-detect duplicates using similarity scoring
- Smart merging: Keep ShipItHQ data as source of truth, enrich with GitHub metrics
...
- **Tactics**:
  - Internal beta with ShipItHQ users
...
KnowMe is a **game-changing feature** that positions ShipItHQ as an innovative platform. The combination of AI, portfolio integration, and hiring platform creates a unique value proposition that's hard to replicate.
