...
## The Buyer's Search Journey

Every buyer goes through stages. Different keyword types map to different stages.

```
Stage 1: Problem Recognition
  "why does my crm keep losing leads"
  "how to track trade show contacts"
  → Searching to understand the problem
  → High awareness content

Stage 2: Solution Research
  "how to build a custom crm"
  "custom crm builder for small business"
  → Searching for ways to solve it
  → Educational / how-to content

Stage 3: Tool Comparison
  "lovable vs bolt for crm"
  "best ai app builder for business"
...
Stage 4: Decision
  ...
  "creatr review"
  "is creatr worth it"
  → Ready to buy, final due diligence
  → Product content, case studies
```

Build content at every stage. Most companies only write Stage 3 and 4. Missing Stages 1 and 2 means you only capture people who already know your name.

---

## Step-by-Step Keyword Research (Free Method)
...
- "custom crm builder"
- "build custom app without developer"
- "no code app builder"
- "ai app builder"
- "build internal tool no code"
...
Type each seed keyword in Google and collect autocomplete suggestions:

```
Search: "custom crm builder"
Autocomplete shows:
  - custom crm builder free
  - custom crm builder for small business
  - custom crm builder platform
  - custom crm builder software
  - custom crm builder open source
```

Go to the bottom of the Google results page:

```
"Related searches" at the bottom shows:
  - best crm builder for startups
  - build your own crm
  - crm builder no code
  - simple crm builder
```
...
Search your seed keyword. The "People Also Ask" box shows questions Google knows people ask. These are:
- Pre-validated as real searches
- Often lower competition than head keywords
- Perfect for FAQ sections and blog post structures

### Step 4: Competitor Content Audit

Find who ranks on page 1 for your seed keywords. Go to their blog/content and note:
- What topics do they write about?
- What topics are they NOT writing about?
- Where is their content weak (thin, outdated, wrong audience)?

The gaps in competitor content = your opportunity.

### Step 5: Filter and Score

For each keyword you've collected, estimate:

**Volume:** Use Google Keyword Planner (free) or Ahrefs free trial. Rough heuristic:
- Lots of results (100M+), strong brands on page 1 = high volume + high competition
- Fewer results, smaller sites on page 1 = lower volume + lower competition
...
- "crm builder for small business" → commercial, people shopping → high intent
- "build crm without code" → transactional, people ready to act → highest intent
...
## Keyword Categories to Prioritize by DR Level
...
Before writing any post, fill this out:
...
EEAT Proof Available: [real example, case study, stat you'll include]
Internal Links To: [2+ pages on your site to link to]
Internal Links From: [2+ existing posts that should link here]
Target Word Count: [based on what ranks]
OG Image Needed: /og/your-slug.png
```

---

## The Low-Hanging Fruit: Category Creation Keywords

The most underrated keyword strategy for startups: find keywords where you can be first.

These are queries that:
- Describe your product's unique differentiator
- Have low search volume today but are growing
...
## Tracking Keywords After Publishing
