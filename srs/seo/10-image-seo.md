...
## ShipItHQ OG Image Implementation (as of June 2026)

### How it works in ShipItHQ (apps/main)
...
ShipItHQ uses **WebP** for all OG images (not PNG). Modern crawlers on WhatsApp, LinkedIn, Twitter/X, iMessage, and Slack all support WebP. The savings are significant: WebP files are 25-50% smaller than equivalent PNGs, which means social crawlers fetch and cache them faster.
