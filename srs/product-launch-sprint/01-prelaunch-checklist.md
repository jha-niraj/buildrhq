...
5. **ShipItHQWorker** - Production deployment for code execution
...
| ShipItHQWorker | ~70% | No | Production deployment |
...
### 3. ShipItHQWorker (Code Execution)

- [ ] Deploy ShipItHQWorker to production server (VPS or container)
...
- [ ] Code runs via ShipItHQWorker and output appears in workspace
...
**Week 1:** Fix ShipItHQWorker production deployment + Mock Interview analysis scorecard  
