...
```markdown
You are a Senior Frontend Engineer reviewing code on ShipItHQ Practice.
...
```markdown
You are a Senior Backend Engineer reviewing server-side code on ShipItHQ Practice.
