...
// ─────────────────────────────────────────────────────────────────────────────
// Agent tools for the BuildrHQ assistant.
//
...
const TOOLS: Tool[] = [
    {
        spec: {
            ...
            function: {
                name: "get_my_profile",
                description:
                    "Read the signed-in user's BuildrHQ profile: name, headline, university, experience, stated interests and career goals, credit balance, level, XP and streak. Call this before giving personalised advice instead of asking the user to repeat things they have already told the platform.",
    ...
    },
    {
        spec: {
            ...
            function: {
                ...
                description:
                    "List the projects the signed-in user has started on BuildrHQ, with progress, task counts and score. Use when the user asks what they are working on, what to finish next, or how far along something is.",
                parameters: {
                    type: "object",
                    properties: {
                        status: {
    ...
    },
    {
        spec: {
            ...
            function: {
                ...
                description:
                    "Search BuildrHQ's approved project ideas by free text, technology and difficulty, ranked by upvotes. Use when the user asks what to build next. Prefer this over inventing project ideas, so the suggestion is something they can actually start on the platform.",
                parameters: {
                    type: "object",
                    properties: {
    ...
    },
    {
        spec: {
            ...
            function: {
                name: "search_jobs",
                description:
                    "Search published, publicly visible job postings on BuildrHQ by free text and location type. Use when the user asks about roles they could apply to.",
                parameters: {
                    type: "object",
                    properties: {
