...
export const RARITY_COLORS: Record<BadgeRarity, RarityConfig> = {
    ...
    RARE: {
        ...
        glow: 'hover:shadow-neutral-900/20',
        gradient: 'from-neutral-800 to-neutral-800',
    },
    EPIC: {
        bg: 'bg-neutral-50 dark:bg-neutral-900',
        text: 'text-neutral-800 dark:text-neutral-100',
    ...
    LEGENDARY: {
        ...
        border: 'border-neutral-300 dark:border-neutral-700',
        ring: 'ring-neutral-800',
        glow: 'hover:shadow-neutral-900/40',
        gradient: 'from-neutral-800 to-neutral-800',
    },
    MYTHIC: {
        ...
        gradient: 'from-pink-400 via-neutral-800 to-neutral-800',
    },
}
