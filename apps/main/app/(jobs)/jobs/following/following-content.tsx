...
function FollowingEmptyState() {
    return (
        <motion.div
            ...
            className="text-center py-16 px-4"
        >
            <div className="w-20 h-20 bg-gradient-to-br from-orange-100 to-orange-100 dark:from-orange-900/30 dark:to-orange-900/30 rounded-3xl flex items-center justify-center mx-auto mb-6">
