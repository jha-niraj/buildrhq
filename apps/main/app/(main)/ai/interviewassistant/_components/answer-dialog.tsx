        ...
        <Dialog open={open} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-[425px]">
                ...
                <div className="flex items-center justify-center p-4 bg-slate-50 dark:bg-slate-900 rounded-lg">
                    <div className="flex items-center gap-2 text-2xl font-semibold text-neutral-800 dark:text-neutral-100">
                ...
                <DialogFooter>
                    ...
                    <Button 
                        ...
                        className="bg-gradient-to-r from-neutral-800 to-neutral-800 hover:from-neutral-700 hover:to-neutral-700"
                    >
                        View Answer
                    </Button>
                </DialogFooter>
