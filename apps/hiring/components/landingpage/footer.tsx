            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
                    ...
                    <div className="col-span-1 md:col-span-3 grid grid-cols-2 md:grid-cols-3 gap-8">
                        ...
                        <div>
                            ...
                            <ul className="space-y-4 text-sm text-neutral-500">
                                <li><Link href="https://shiprhq.com" target="_blank" className="hover:text-neutral-900 dark:hover:text-white transition-colors">ShiprHQ Main</Link></li>
                        ...
                        <div>
                            ...
                            <div className="flex gap-4">
                                <Link href="https://twitter.com/shiprhq" target="_blank" className="text-neutral-400 hover:text-neutral-900 dark:hover:text-white"><Twitter className="w-5 h-5" /></Link>
                                <Link href="https://github.com/shiprhq" target="_blank" className="text-neutral-400 hover:text-neutral-900 dark:hover:text-white"><Github className="w-5 h-5" /></Link>
                                <Link href="https://linkedin.com/company/shiprhq" target="_blank" className="text-neutral-400 hover:text-neutral-900 dark:hover:text-white"><Linkedin className="w-5 h-5" /></Link>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="pt-8 border-t border-neutral-200 dark:border-neutral-800 flex flex-col sm:flex-row justify-between items-center gap-4">
                    <div className="text-[10px] text-neutral-500 font-mono">
                        © {new Date().getFullYear()} ShiprHQ - All rights reserved
                    </div>
