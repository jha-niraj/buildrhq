...
export const metadata: Metadata = {
    ...
    description:
        'BuildrHQ pricing is credit-based — no subscriptions, no idle-time charges. Buy credits once and spend them on AI mock interviews, project generation, assessments and more. Credits never expire.',
    openGraph: {
        title: 'BuildrHQ Pricing — Pay Only for What You Run',
        description:
