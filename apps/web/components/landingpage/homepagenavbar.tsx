        ...
        <nav className={`fixed top-0 w-full pl-3 pr-3 z-50 transition-all duration-300 
            ...
            <div className="max-w-7xl mx-auto flex items-center justify-between h-16">
                ...
                <div className={`hidden md:flex items-center space-x-1 rounded-full transition-all duration-300 p-1 -mr-6
                    ...
                    <Link href="/pricing" className={`${linkBaseClasses} ${standardLinkClasses} ${pathname === '/pricing' ? 'bg-white dark:bg-neutral-800 text-neutral-900 dark:text-white shadow-sm' : ''}`}>Pricing</Link>
                </div>
                                ...
                                <div className="flex flex-col h-full">
                                    <div className="flex-1 overflow-auto py-6 px-4 font-medium">
                                        <div className="grid grid-cols-1 gap-2">
                                            ...
                                            <Link href="/pricing" onClick={() => setIsMobileMenuOpen(false)} className="rounded-lg px-4 py-3 text-lg text-neutral-600 dark:text-neutral-400 hover:bg-neutral-50 dark:hover:bg-neutral-900 hover:text-neutral-900 dark:hover:text-white transition-all">Pricing</Link>
                                        </div>
                                    </div>
                                </div>
                            </SheetContent>
