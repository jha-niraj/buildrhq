...
function FilledCheck() {
    return (
        <div className="bg-gradient-to-r from-orange-500 to-amber-500 text-white rounded-full p-0.5">
            ...
            >
                ...
                <div className="flex flex-col p-5 lg:flex-row">
                    <div className="pb-4 lg:w-[35%]">
                        ...
                        <p className="text-orange-500 dark:text-orange-400 text-sm mt-2 font-medium">
                            Save 12% vs regular
                        </p>
                    </div>
                ...
                showFreeCredits && (
                    <div
                        className={cn(
                            ...
                            'border-orange-200 dark:border-orange-800 relative w-full overflow-hidden rounded-2xl border',
                            'lg:col-span-8',
