    ...
    return (
        <div className="flex items-start gap-4 rounded-2xl border border-neutral-200 bg-neutral-50 p-6 dark:border-neutral-800 dark:bg-neutral-900/60">
            ...
            <div className="min-w-0">
                <p className="mb-1 font-mono text-[10px] uppercase tracking-[0.18em] text-neutral-400 dark:text-neutral-500">
                    Written by
                </p>
                ...
                <div className="mt-3 flex flex-wrap items-center gap-x-4 gap-y-1 text-[12px]">
                    {author.sameAs.map((url) => (
                        <a
                            ...
                            className="text-neutral-400 underline-offset-4 transition-colors hover:text-neutral-900 hover:underline dark:text-neutral-500 dark:hover:text-white"
                        >
