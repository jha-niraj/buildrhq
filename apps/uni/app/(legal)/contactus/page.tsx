                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    >
                        ...
                        <div className="bg-neutral-50 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-8 hover:border-neutral-300 dark:hover:border-neutral-700 transition-colors">
                            ...
                            <a href="mailto:sales@buildrhq.com" className="flex items-center gap-2 font-medium text-sm text-neutral-800 dark:text-neutral-100 hover:underline">
                        ...
                        <div className="bg-neutral-50 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-8 hover:border-neutral-300 dark:hover:border-neutral-700 transition-colors">
                            ...
                            <a href="mailto:support@buildrhq.com" className="flex items-center gap-2 font-medium text-sm text-neutral-800 dark:text-neutral-100 hover:underline">
                            ...
                            <div className="space-y-8">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:university@buildrhq.com" className="text-neutral-500 hover:text-neutral-800 dark:hover:text-neutral-100 transition-colors">
                                            university@buildrhq.com
                                        </a>
                                    </div>
                                </div>
                                <div className="flex items-start gap-4">
