...
const footerLinks = {
    ...
    platforms: [
        { label: "Main Platform", href: "https://shipithq.com" },
        { label: "ShipItHQ Hiring", href: "https://hiring.shipithq.com" },
        { label: "For Students", href: "https://shipithq.com" },
    ]
}
            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="pt-8 border-t border-neutral-200 dark:border-neutral-800 flex flex-col md:flex-row items-center justify-between gap-4">
                    <p className="text-[10px] font-mono text-neutral-500">
                        © {new Date().getFullYear()} ShipItHQ University.
                    </p>
