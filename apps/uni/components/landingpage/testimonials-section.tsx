...
const testimonials = [
    {
        text: "ShiprHQ completely transformed my coding journey. The AI interview prep helped me land my first internship at a startup!",
    ...
    {
        text: "Learning to code was intimidating until I found ShiprHQ. The structured paths made everything click into place.",
